---
description: 'sageDB development agent for FAISS-like vector database with pluggable ANNS algorithms'
tools: ['vscode', 'execute', 'read', 'agent', 'edit', 'search', 'web', 'todo']
---

# sageDB Development Agent

## Purpose
This agent assists with developing, testing, and maintaining the sageDB C++ vector database library. It understands the FAISS-compatible API design, pluggable ANNS architecture, and multimodal fusion capabilities.
...
- **Entry points**: `SageDB`/`VectorStore`/`QueryEngine` in include/sage_db; ANNS plugins under src/anns and registered via `REGISTER_ANNS_ALGORITHM`
...
- Run tests (from build): `ctest --verbose` or `./test_sage_db`, `./test_multimodal`
...
- Tests green (`test_sage_db`, `test_multimodal`)
